...
app.get("/api/health",(q,r)=>r.json({ok:true,version:"11",klap:false,engine:"faster-whisper + OpenCV face tracking + FFmpeg",ollama:!!process.env.OLLAMA_BASE_URL}));
...
app.listen(PORT,"0.0.0.0",()=>console.log("Clip Finder V12 running on "+PORT));